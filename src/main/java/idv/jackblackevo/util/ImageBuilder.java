...
public interface ImageBuilder {
   ...
   * 合併成多頁 TIFF。
   *
   * @param destLocation             目標目錄路徑
   * @param isCloseBuilderAfterWrote 結束時是否關閉 ImageBuilder
   * @return 產出之 TIFF
   * @throws IOException
   */
   ...
   *
   * @param destLocation             目標目錄路徑
   * @param quality                  TIFF 品質，0.0f - 1.0f
   * @param isCloseBuilderAfterWrote 結束時是否關閉 ImageBuilder
   * @return 產出之 TIFF
   * @throws IOException
   */
